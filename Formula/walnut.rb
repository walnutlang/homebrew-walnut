class Walnut < Formula
  ...
  version "0.4.2"
  url "https://github.com/walnutlang/homebrew-tap/releases/download/v0.4.2/walnut-0.4.2-darwin-arm64.tar.gz"
  sha256 "2e3be36161fc096f4128a2b3e36b181e2f06d99c885fc96dc0d018605a5a1617"
  ...
  test do
    ...
    assert_match "walnut 0.4.2", shell_output("#{bin}/walnut version")
